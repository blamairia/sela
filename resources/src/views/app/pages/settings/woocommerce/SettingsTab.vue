<template>
  <div>
    ...
    <b-card class="mt-3" header="Auto Sync Guide (Sela → WooCommerce)">
      <b-card-text>
        <p class="mb-2"><strong>What it does</strong></p>
        <ul class="mb-3">
          <li>Products: Pushes products from Sela to WooCommerce (create/update).</li>
          <li>Stock: Pushes stock quantities/status from Sela to WooCommerce.</li>
        </ul>
        ...
        <ul class="mb-3">
          <li>Products tab: <em>Run Manual Sync Now</em> or <em>Sync Only Unsynced</em> (Sela → WooCommerce).</li>
